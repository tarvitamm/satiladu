...
function createProductListDiv() {
  ...
  for(i=0;i<ProductsWMS.length+1;i++) {
    ...
    if (i == 2){
        document.getElementById('D-ProductList').innerHTML += '<div title="Filter:  ' + filterInfo + '" onclick="' + onClickStr + '" class="' + filterButton + '" style="z-index: 99999900; cursor:pointer; height:2.2em; width:6.9em; margin-top:0.5em;"><table width="100%" height="100%" border="0"><tr><td nowrap valign="center" align="center"><span>' + filterTXT + '</span></td></tr></table><button class="LegendButtonDesigned" id="legendButtonDesigned-2" style="position: absolute; bottom: 36.8em; right:1em;">L</button></div>';
        document.getElementById('D-ProductList').innerHTML +=  '<div id="tableContainerDesigned-2" style="display:none; position:absolute; bottom:35em; right:12em; background-color:white; border:1px solid black; padding:1em;"><table id="legendTableDesigned-2" border="1" style="width: 200px;"></table></div>'
    }
    else if (i == 4){
        document.getElementById('D-ProductList').innerHTML += '<div title="Filter:  ' + filterInfo + '" onclick="' + onClickStr + '" class="' + filterButton + '" style="z-index: 99999900; cursor:pointer; height:2.2em; width:6.9em; margin-top:0.5em;"><table width="100%" height="100%" border="0"><tr><td nowrap valign="center" align="center"><span>' + filterTXT + '</span></td></tr></table><button class="LegendButtonDesigned" id="legendButtonDesigned-4" style="position: absolute; bottom: 30.3em; right:1em;">L</button></div>';
        document.getElementById('D-ProductList').innerHTML +=  '<div id="tableContainerDesigned-4" style="display:none; position:absolute; bottom:35em; right:12em; background-color:white; border:1px solid black; padding:1em;"><table id="legendTableDesigned-4" border="1" style="width: 200px;"></table></div>'
    }
    else document.getElementById('D-ProductList').innerHTML += '<div title="Filter:  ' + filterInfo + '" onclick="' + onClickStr + '" class="' + filterButton + '" style="z-index: 99999900; cursor:pointer; height:2.2em; width:6.9em; margin-top:0.5em;"><table width="100%" height="100%" border="0"><tr><td nowrap valign="center" align="center"><span>' + filterTXT + '</span></td></tr></table></div>';
  }
}
...
borders_legend_urls = ['https://teenus.maaamet.ee/ows/wms-satiladu?version=1.1.1&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=katastriuksused&format=image/png&STYLE=default', '','','https://teenus.maaamet.ee/ows/wms-satiladu?version=1.1.1&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=kaitsealad&format=image/png&STYLE=default','https://teenus.maaamet.ee/ows/wms-satiladu?version=1.1.1&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=kaitsemetsad&format=image/png&STYLE=default', 'https://gsavalik.envir.ee/geoserver/metsaregister/wms?service=WMS&version=1.1.0&request=GetLegendGraphic&layer=metsaregister:teatis&FORMAT=image/png&WIDTH=27&HEIGHT=27', 'https://teenus.maaamet.ee/ows/wms-satiladu?version=1.1.1&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=pollumassiivid&format=image/png&STYLE=default', '', '', '']
borders_legend_titles = ['','','','kaitsealad','kaitsemets','- metsateatiste piir', 'põld', '', '', '']
...
else_legend_urls = ['https://teenus.maaamet.ee/ows/ai_tuletised?version=1.1.1&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=ai_surnud_puud&format=image/png&STYLE=default', 'https://kls.pria.ee/geoserver/pria_avalik/ows?version=1.1.1&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=pria_mesilad&format=image/png'];
